...
$(function () {
    ...
    function showImg(thisObj) {
        ...
        var button = $('.perfect-incourse');
        switch(num){
            case 1: button.css('display','none');break;
            case 2: button.css('top',403).css('right',160);break;
            case 3: button.css('top',404).css('right',896);break;
            case 4: button.css('top',455).css('right',940);break;
            case 5: button.css('top',433).css('right',637);break;
            case 6: button.css('top',426).css('right',608);break;
        }
